...
function y(e, t = {}) {
  return (
    ...
    { type: se, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates }
  );
}
function O(e, t = '', n = {}) {
  ...
  switch (r.kind) {
    ...
    case 'Field':
      return y([
        r.alias ? [n('alias'), ': '] : '',
        n('name'),
        r.arguments.length > 0 ? y(['(', x([p, E([O('', ', '), p], g(e, t, n, 'arguments'))]), p, ')']) : '',
        _(e, n, r),
        r.selectionSet ? ' ' : '',
        n('selectionSet'),
      ]);
	...
	`);
        return (
          i.length === 1 && (i[0] = i[0].trim()), i.every((s) => s === '') && (i.length = 0), E(f, ['"""', ...i, '"""'])
        );
      }
      return [
        '"',
      ...
      return (
        ...
        i.startsWith('ObjectType')
          ...
          : i.startsWith('InputObjectType')
            ...
            : s.push('interface'),
        s.push(' ', n('name')),
        !i.startsWith('InputObjectType') && r.interfaces.length > 0 && s.push(' implements ', ...vt(e, t, n)),
        s.push(_(e, n, r)),
        r.fields.length > 0 && s.push([' {', x([f, E(f, g(e, t, n, 'fields'))]), f, '}']),
        s
      );
    }
    ...
    case 'EnumTypeDefinition':
      return [
        ...
        n('name'),
        _(e, n, r),
        r.values.length > 0 ? [' {', x([f, E(f, g(e, t, n, 'values'))]), f, '}'] : '',
      ];
    ...
    case 'SchemaExtension':
      return [
        'extend schema',
        _(e, n, r),
        ...(r.operationTypes.length > 0 ? [' {', x([f, E(f, g(e, t, n, 'operationTypes'))]), f, '}'] : []),
      ];
    case 'SchemaDefinition':
      return [
        ...
        _(e, n, r),
        ' {',
        r.operationTypes.length > 0 ? x([f, E(f, g(e, t, n, 'operationTypes'))]) : '',
        f,
        '}',
      ];
    ...
    case 'UnionTypeDefinition':
      return y([
        ...
        y([
          ...
          n('name'),
          _(e, n, r),
          r.types.length > 0 ? [' =', O('', ' '), x([O([k, '| ']), E([k, '| '], e.map(n, 'types'))])] : '',
        ]),
      ]);
...
function be(e, t) {
  ...
  return ue(n.variableDefinitions)
    ? y(['(', x([p, E([O('', ', '), p], e.map(t, 'variableDefinitions'))]), p, ')'])
    : '';
}
function Le(e, t) {
  e.kind === 'StringValue' &&
...
function fe(e, t) {
  ...
  if (D.length > 120) {
    ...
    return (
      T + Ue([[`${a} |`, N[0]], ...N.slice(1, I + 1).map((v) => ['|', v]), ['|', '^'.padStart(ie)], ['|', N[I + 1]]])
    );
  }
  return (
    T +
...
var W = class e extends Error {
  constructor(t, ...n) {
    ...
    (this.source = u ?? (I == null || (i = I[0]) === null || i === void 0 ? void 0 : i.source)),
      (this.positions = l ?? (I == null ? void 0 : I.map((N) => N.start))),
      (this.locations = l && u ? l.map((N) => B(u, N)) : I == null ? void 0 : I.map((N) => B(N.source, N.start)));
...
function Ut(e, t, n) {
  ...
  if (
    (s === 46 && ((a = !0), (s = r.charCodeAt(++i)), (i = de(e, i, s)), (s = r.charCodeAt(i))),
    (s === 69 || s === 101) &&
      ((a = !0),
      (s = r.charCodeAt(++i)),
...
function Xe(e, t) {
  return (
    (U(e.charCodeAt(t)) << 12) | (U(e.charCodeAt(t + 1)) << 8) | (U(e.charCodeAt(t + 2)) << 4) | U(e.charCodeAt(t + 3))
  );
}
function U(e) {
...
var me = class {
  ...
  parseFragment() {
    ...
    return !n && this.peek(o.NAME)
      ? this.node(t, { kind: c.FRAGMENT_SPREAD, name: this.parseFragmentName(), directives: this.parseDirectives(!1) })
      : this.node(t, {

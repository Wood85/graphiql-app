...
var Me = (e, t, r) => (
    (r = e != null ? yu(wu(e)) : {}),
    ar(t || !e || !e.__esModule ? He(r, 'default', { value: e, enumerable: !0 }) : r, e)
  ),
  vu = (e) => ar(He({}, '__esModule', { value: !0 }), e);
var bu = (e, t, r) => t.has(e) || sr('Cannot ' + r);
var Dr = (e, t, r) =>
  t.has(e) ? sr('Cannot add the same private member more than once') : t instanceof WeakSet ? t.add(e) : t.set(e, r);
...
Z.prototype = {
  ...
  addToPath: function (t, r, n, o) {
    ...
    return u && u.added === r && u.removed === n
      ...
      : { oldPos: t.oldPos + o, lastComponent: { count: 1, added: r, removed: n, previousComponent: u } };
  },
      ...
      switch (i) {
        ...
        case x:
          if (n && u.expandedStates)
            for (let s = u.expandedStates.length, a = s - 1; a >= 0; --a) o.push(u.expandedStates[a]);
...
function _t(e, t = {}) {
  return (
    ...
    { type: x, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates }
  );
}
function Cr(e) {
...
function Or(e) {
  ...
  function n(u, i, s) {
    ...
    if (u.type === b)
      return ((D = s == null ? void 0 : s[i - 1]) == null ? void 0 : D.type) === B && s[i - 1].hard
        ? void 0
        : 'breakParent';
...
function Wu(e) {
  if ((e.type === x && e.break) || (e.type === B && e.hard) || e.type === b) return !0;
}
function Ir(e) {
  return Xe(e, Wu, !1);
}
...
function Lt(e, t) {
  (e.comments ?? (e.comments = [])).push(t), (t.printed = !1), (t.nodeDescription = to(e));
}
function ue(e, t) {
...
function ut(e, t) {
  ...
  if (!n) return [];
  let s = ((r == null ? void 0 : r(e, t)) ?? [...Tt(e, { getVisitorKeys: X(o) })]).flatMap((a) =>
    n(a) ? [a] : ut(a, t),
  );
...
function Jr(e, t) {
  ...
  for (let [p, c] of f.entries()) {
    ...
    let v;
    if (
      (i ? (v = [c]) : ((F.enclosingNode = E), (F.precedingNode = m), (F.followingNode = A), (v = [F, w, h, C, k])),
      ro(w, h, f, p))
    )
  ...
  for (let o of lo(Object.assign({}, ...e.map(({ options: u }) => u), rn)))
    (!t && o.deprecated) ||
      (Array.isArray(o.choices) &&
        ...
        o.name === 'parser' && (o.choices = [...o.choices, ...Do(o.choices, r, e)])),
...
function nn(e, t) {
  ...
  return (
    e.find(({ filenames: n }) => (n == null ? void 0 : n.some((o) => o.toLowerCase() === r))) ??
    e.find(({ extensions: n }) => (n == null ? void 0 : n.some((o) => r.endsWith(o))))
  );
}
function fo(e, t) {
  if (t)
...
function po(e, t) {
  let r = e.plugins.flatMap((o) => o.languages ?? []),
    n = fo(r, t.language) ?? nn(r, t.physicalFile) ?? nn(r, t.file) ?? (t.physicalFile, void 0);
...
var Dn = ' '.repeat(2),
  cn = (e, t, r) => {
    ...
    return (
      ...
      o &&
        u.push(
          [ln(e, t, o.title, r.descriptor)].concat(o.values.map((i) => fn(i, r.loggerPrintWidth))).join(`
`),
        ),
...
function fn({ text: e, list: t }, r) {
  ...
  return (
    ...
    t &&
      n.push(
        [`- ${le.default.blue(t.title)}:`].concat(t.values.map((o) => fn(o, r - Dn.length).replace(/^|\n/g, `$&${Dn}`)))
          .join(`
`),
      ),
    pn(n, r)
...
function $t(e) {
  ...
  let { text: t, list: r } = e;
  return (
    ho((t || r) !== void 0, 'Unexpected `expected` result, there should be at least one field.'),
...
var Gt;
function go(e, t, { logger: r = !1, isCLI: n = !1, passThrough: o = !1, FlagSchema: u, descriptor: i } = {}) {
  if (n) {
...
function Ao(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
  ...
  return e.array
    ? ct.create({ ...(t ? { preprocess: (a) => (Array.isArray(a) ? a : [a]) } : {}), ...s, valueSchema: i.create(u) })
    : i.create({ ...u, ...s });
}
var bn = go;
var Bo = (e, t, r) => {
...
async function wo(e, t = {}) {
  ...
  let n = ot({ plugins: e.plugins, showDeprecated: !0 }).options,
    o = { ...Nn, ...Object.fromEntries(n.filter((f) => f.default !== void 0).map((f) => [f.name, f.default])) },
    u = qt(r.plugins, r.parser),
    i = await Jt(u, r.parser);
  (r.astFormat = i.astFormat), (r.locEnd = i.locEnd), (r.locStart = i.locStart);
  let s = (d = u.printers) != null && d[i.astFormat] ? u : On(r.plugins, i.astFormat),
...
async function Po(e, t, r, n) {
  let o = await se({ ...r, ...t, parentParser: r.parser, originalText: e }, { passThrough: !0 }),
    { ast: u } = await ce(e, o),
    i = await n(u, o);
  return Ze(i);
}
function Io(e, t) {
  let { originalText: r, [Symbol.for('comments')]: n, locStart: o, locEnd: u, [Symbol.for('printedComments')]: i } = t,
    { node: s } = e,
    a = o(s),
    D = u(s);
...
function Gn(e, t, r, n, o) {
  ...
  return (
    ...
    i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(e, t)) && (s = Qr(e, s, t)),
    s
  );
}
...
var pi = fe(ot, 0),
  di = { parse: fe(su), formatAST: fe(au), formatDoc: fe(Du), printToDoc: fe(lu), printDocToString: fe(cu) };
var fc = ir;
export {
  di as __debug,
  fi as check,
